  ...
  return (
    <div className="min-h-screen" style={{ background: PAPER, color: INK, ...manrope }}>
      ...
      <main className="mx-auto max-w-3xl px-6 py-24">
        ...
        <p className="mt-4 text-sm" style={{ color: INK_SOFT }}>Last updated: May 28, 2026</p>
        ...
        <div className="mt-12 space-y-10 text-base leading-relaxed" style={{ color: INK_SOFT }}>
          ...
          <Section title="How we protect Google user data">
            ...
            <ul className="mt-3 list-disc space-y-2 pl-6">
              ...
              <li>Sensitive content — email subjects, snippets, bodies, recipient lists, AI-generated summaries and classification reasons, your saved reply drafts, and contact notes, phone numbers, and addresses — is encrypted at the column level using authenticated encryption (pgcrypto AEAD) with a server-held key, so the raw text is unreadable directly from the database. Routing fields needed to deliver and de-duplicate mail (sender address, Gmail message and thread identifiers, labels) are stored alongside in our managed Postgres database with disk-level encryption at rest provided by our infrastructure provider.</li>
