      ...
      <main className="mx-auto max-w-3xl px-6 py-24">
        ...
        <div className="mt-12 space-y-10 text-base leading-relaxed" style={{ color: INK_SOFT }}>
          ...
          <Section title="AI output">
            Classifications, summaries, and suggested replies are generated by AI and may be wrong.
            Review important messages yourself before acting on them. You are responsible for any
            email you send.
          </Section>
