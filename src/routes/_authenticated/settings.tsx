...
function DangerZone() {
  ...
  return (
    <Card className="border-destructive/40 p-4 md:p-6">
      ...
      <p className="mt-1 text-sm text-muted-foreground">
        Permanently delete your Zerrow account, revoke Google access, and remove all synced messages, folders, contacts, and settings. This cannot be undone.
      </p>
        ...
        <AlertDialogContent>
          <AlertDialogHeader>
            ...
            <AlertDialogDescription>
              This will revoke Google access on all connected mailboxes, delete every email, folder, filter, contact, and queued job we hold for you, and remove your sign-in. It cannot be undone.
            </AlertDialogDescription>
          </AlertDialogHeader>
